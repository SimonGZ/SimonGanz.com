...
<div class="video-container">
  <video
    loop
    controls
    poster="http://fountainloader.com/videos/fountain-loader-2.png"
  >
    <source
      id="webmsource"
      src="http://fountainloader.com/videos/fountain-loader-2.webm"
      type="video/webm"
    />
    <source
      id="mp4source"
      src="http://fountainloader.com/videos/fountain-loader-2.mp4"
      type="video/mp4"
    />
...
- [http://fountainloader.com](http://fountainloader.com)
- For more information about how Fountain Loader works, check out [my original post announcing the project][Fountain Loader project page].
- If you want to learn how to write in fountain, check out the [fountain syntax page][fountain].
