...
import manOfSteel from '../../assets/images/manOfSteel.jpg';
import DeferredYouTube from '../../components/DeferredYouTube.astro';

<Picture src={manOfSteel} formats={['avif', 'webp']} alt="Man of Steel" />
...
<DeferredYouTube
  src="https://www.youtube.com/embed/FPaTv98wUsE"
  title="The Dark Knight batpod sequence"
/>
