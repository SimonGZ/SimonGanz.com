...
import originalCrew from '../../assets/images/StarTrekTOSCrew.jpg';

<Picture src={originalCrew} formats={['avif', 'webp']} alt="Star Trek Original Crew" />
