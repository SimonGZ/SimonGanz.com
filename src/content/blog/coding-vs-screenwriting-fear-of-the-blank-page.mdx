...
description: "A discussion of why coding is sometimes less intimidating than creative writing."
---



import { Picture } from 'astro:assets';
import screenplaysAsCode from '../../assets/images/scriptAsCode.png';

<Picture src={screenplaysAsCode} formats={['avif', 'webp']} alt="Screenplays as Code" />
