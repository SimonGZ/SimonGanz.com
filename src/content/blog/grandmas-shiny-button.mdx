...
description: "A series of increasingly elaborate attempts to make Mets games accessible to a visually impaired grandmother."
---

import { Picture } from 'astro:assets';
import powermate from '../../assets/images/powermate.jpg';

<Picture src={powermate} formats={['avif', 'webp']} alt="Griffin Powermate" />
...
3. Buy [Griffin PowerMate](http://www.griffintechnology.com/products/powermate)
4. Set up PowerMate so that one button press launches Safari and raises the volume, and one long button press quits Safari and mutes the volume
...
I've since repurposed the PowerMate button to control iTunes and play/pause audiobooks for Grandma.
